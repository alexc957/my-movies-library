export const POPULAR_MOVIES = {
  ...
  "total_pages": 34458,
  "total_results": 689148
}

export const TOP_MOVIES_RESULT = {
  page: 1,
  results: [
    {
      adult: false,
    ...
    {
      adult: false,
      backdrop_path: "/a7p3RuCocDAwurgu2bJbAEhJagf.jpg",
      genre_ids: [12, 14, 28],
      id: 122,
      original_language: "en",
...
export const UPCOMING_MOVIES = {
  ...
  "results": [
      ...
      },
      {
          ...
          "overview": "The True Story of Ted Kaczynski, the infamous Unabomber, who wants to destroy modern technology to create a world for himself in the Montana wilderness.",
          "popularity": 209.345,
          "poster_path": "/xgBzMsP8a10rEHXNSytPsLhwUVF.jpg",
      ...
      },
      {
          ...
          "overview": "Kate and her daughter Beth live alone in an isolated farmhouse in the woods, but when Kate slowly begins to suspect that something sinister is happening, her motherly instincts are put to the test.",
          "popularity": 182.444,
      ...
      },
      {
          ...
          "overview": "A hard-on-his-luck hound finds himself in a town full of cats who need a hero to defend them from a ruthless villain's evil plot to wipe their village off the map. With help from a reluctant teacher to train him, our underdog must assume the role of town samurai and team up with the villagers to save the day.",
          "popularity": 170.3,
      ...
      },
      {
          ...
          "original_language": "en",
          "original_title": "Luck",
          "overview": "Suddenly finding herself in the never-before-seen Land of Luck, Sam Greenfield, the unluckiest person in the world, must unite with the magical creatures there to turn her luck around.",
          "popularity": 65.092,
